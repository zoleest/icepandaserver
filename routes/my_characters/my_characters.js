...
router.get('/', async function(req,res){
    ...
    if(req.session.loggedIn !== undefined) {
        ...
        let characters = await MongoDBCollection.find({"character_user_username": req.session.userName, "character_isactive": 1},{projection:{"character_name":1, "character_name_slug": 1 }}).toArray();
